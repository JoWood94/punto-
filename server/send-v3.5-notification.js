...
async function sendV35Notification() {
  console.log("[punto! v3.5.0] Invio notifiche push a tutti gli utenti...");
  ...
  try {
      ...
      try {
        const response = await messaging.sendEachForMulticast({
          ...
          webpush: {
            notification: {
              title: 'punto! 3.5',
              body: 'Promemoria scaduti: ora puoi evadere ricorrenze passate. Aggiunte impostazioni e miglioramenti stabilità. Chiudi e riapri l\'app per aggiornare.',
    ...
    console.log(`\n[Completato] Notifiche v3.5.0 inviate: ${totalSent}/${usersWithTokens} utenti`);
