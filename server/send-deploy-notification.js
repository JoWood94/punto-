...
async function sendDeployNotification() {
  console.log("[Deploy v2.0.3] Invio notifiche push a tutti gli utenti...");
  ...
  try {
      ...
      try {
        const response = await messaging.sendEachForMulticast({
          ...
          webpush: {
            notification: {
              title: 'punto! v2.0.3',
              body: 'fix layout tastiera iOS e blocchi TESTO',
    ...
    console.log(`\n[Completato] Notifiche inviate: ${totalSent}/${usersWithTokens} utenti`);
