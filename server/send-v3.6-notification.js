...
async function sendV36Notification() {
  console.log("[punto! v3.6 Patch] Invio notifiche push a tutti gli utenti...");
  ...
  try {
    ...
    console.log(`\n[Completato] Notifiche v3.6 Patch inviate: ${totalSent}/${usersWithTokens} utenti`);
